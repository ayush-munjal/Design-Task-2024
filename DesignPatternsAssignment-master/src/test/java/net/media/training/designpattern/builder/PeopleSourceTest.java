...
public class PeopleSourceTest {
    ...
    public void TestPeopleXml() {
        ...
        persons.add(personBuilder.setCity("Shanghai").setCountry("China").setId(25).setName("Wu").build());
        persons.add(personBuilder.setCity("Kanto").setCountry("Japan").setId(200).setName("Kobayashi").build());
        persons.add(personBuilder.setCity("Leningrad").setCountry("Russia").setId(1).setName("Vasily").build());
