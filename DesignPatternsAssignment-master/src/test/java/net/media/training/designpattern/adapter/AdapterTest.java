...
import net.media.training.designpattern.adapter.thirdparty.ThirdPartyLeaveRecordAdapter;
...
public class AdapterTest {
    ...
    public void testGetDisplayWallOfShame() throws Exception {
       FrontDoorRegister frontDoorRegister = new FrontDoorRegister(new ThirdPartyLeaveRecordAdapter(new ThirdPartyLeaveRecord()));
    ...
    public void salaryDisbersmentTest() {
     SalaryDisberser salaryDisberser = new SalaryDisberser(new ThirdPartyLeaveRecordAdapter(new ThirdPartyLeaveRecord()));
